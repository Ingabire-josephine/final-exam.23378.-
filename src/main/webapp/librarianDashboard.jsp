...
<body>
  <!-- Navigation Bar -->
  <div class="navbar">
    <a href="addShelf.jsp">Register Shelf</a>
    <a href="addBook.jsp">Register Book</a>
    <a href="approveRequest.jsp">Allow Membership</a>
      <a href="viewBooks.jsp">available books</a>
    <a href="#borrowed-books">Borrowed Books</a>
    <a href="#returned-books">Returned Books</a>
    <a href="listUsers.jsp">List of User</a>
    <a href="#profile">Profile</a>
  </div>

  <!-- Centered Content -->
  <div class="content">
    <h1>Welcome in librarian page</h1>
